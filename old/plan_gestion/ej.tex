...
%% Un requisito no funcional especifica criterios que pueden usarse para juzgar la operación de un sistema, se refieren a todos los requisitos que no describen información a guardar, ni funciones a realizar, sino características de funcionamiento; son las restricciones o condiciones que impone el cliente.
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\item El sistema permite a\~nadir cualquier canci\'on a favoritos.
			\item El sistema permite crear listas de reproducci\'on p\'ublicas
			\item El sistema permite a\~nadir cualquier canci\'on a una lista de reproducci\'on previamente creada por el usuario.
		...
		\item Administrador
		\begin{enumerate}
			\item El usuario administrador se identifica en la aplicaci\'on con un usuarios y contrase\~na predefinidos.
